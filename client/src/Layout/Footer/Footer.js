    ...
    <div className='container mx-auto px-2'>
      <div className='grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between'>
       ...
       <div className='pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3'>
        <Link to='/'>
          <img src='https://cdn.imgbin.com/14/7/22/imgbin-logo-art-fullmetal-alchemist-design-wWQD0KFPj71yKzxqenvs49srg.jpg' alt='logo' className='w-2/4 object-contain h-12'/>
        </Link>
        <p className='leading-7 text-sm text-border mt-3'>
          <span> tel +216 xx-xxx-xxx</span>
          <br/>
          <span>Email:redfoxx235@gmail.com</span>
        </p>
       </div>
