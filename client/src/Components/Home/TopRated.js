       ...
       modules={[Navigation,Autoplay]}>
        {
          movies.map((movie,index)=>(
            <SwiperSlide key ={index}>
              ...
              <div className='px-4 hoveres flex-colo gap-6 text-center absolute bg-black bg-opacity-70 top-0 left-0 right-0 bottom-0'>
                ...
                to ={`/movie/${movie.name}`}>{movie.name}</Link>
