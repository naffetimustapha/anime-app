...
const MainModal = ({modalOpen , setModalOpen,children}) => {
  ...
  <Transition show={modalOpen} as={Fragment} appear>
    <Dialog as="div" className="fixed inset-0 z-30 overflow-y-auto text-center" 
    ...
    onClose={()=>setModalOpen(false)}>
        <div className='min-h-screen px-4'>
         ...
         <div className='absolute-right-5 top-5'>
            ...
            type='button' 
            className='transitions w-10 h-10 text-base font-bold text-white bg-subMain rounded-full hover:bg-white hover:text-subMain'>
                <IoCloseCircle/>
            </button>
         </div>
        </div>
